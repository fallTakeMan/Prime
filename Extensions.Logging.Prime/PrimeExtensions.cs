...
namespace Extensions.Logging.Prime
{
    public static class PrimeExtensions
    {
        ...
        public static ILoggingBuilder AddPrime(this ILoggingBuilder builder, [Optional] Action<PrimeOptions> func)
        {
            ...
            {
                DatabaseType.MSSQL => opt.UseSqlServer(prime.ConnectionString),
                DatabaseType.MySql => opt.UseMySQL(prime.ConnectionString),
                DatabaseType.PostgreSQL => opt.UseNpgsql(prime.ConnectionString),
